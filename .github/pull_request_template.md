...
that was tested. Explain failures and missing checks. For numerical changes,
include before/after values and reference settings; do not present a small smoke
check as full numerical qualification.
...
- [ ] I have read CONTRIBUTING.md, including its existing licensing terms.
