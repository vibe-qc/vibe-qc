...
Compound metadata:
    ...
    a, b, c (Å):    5.6740, 5.6740, 5.6740
    α, β, γ (deg):  90.00, 90.00, 90.00
    n_atoms in cell: 8
    multiplicity:   1
    structure src:  PT2013 Ref. 80
...
def main() -> None:
    lattice = np.array([
        [10.7223052593, 0.0000000000, 0.0000000000],
        [0.0000000000, 10.7223052593, 0.0000000000],
        [0.0000000000, 0.0000000000, 10.7223052593],
    ])  # bohr

    unit_cell = [
        vq.Atom(30, [  0.0000000000,   0.0000000000,   0.0000000000]),  # Z30 frac=(0.000,0.000,0.000)
        vq.Atom(30, [  5.3611526297,   5.3611526297,   0.0000000000]),  # Z30 frac=(0.500,0.500,0.000)
        vq.Atom(30, [  5.3611526297,   0.0000000000,   5.3611526297]),  # Z30 frac=(0.500,0.000,0.500)
        vq.Atom(30, [  0.0000000000,   5.3611526297,   5.3611526297]),  # Z30 frac=(0.000,0.500,0.500)
        vq.Atom(34, [  2.6805763148,   2.6805763148,   2.6805763148]),  # Z34 frac=(0.250,0.250,0.250)
        vq.Atom(34, [  8.0417289445,   8.0417289445,   2.6805763148]),  # Z34 frac=(0.750,0.750,0.250)
        vq.Atom(34, [  8.0417289445,   2.6805763148,   8.0417289445]),  # Z34 frac=(0.750,0.250,0.750)
        vq.Atom(34, [  2.6805763148,   8.0417289445,   8.0417289445]),  # Z34 frac=(0.250,0.750,0.750)
    ]
    ...
    print(f"  cell:       {lattice[0][0]:.4f} bohr (= 5.6740 Å)")
