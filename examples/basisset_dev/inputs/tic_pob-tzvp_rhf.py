...
def main() -> None:
    lattice = np.array([
        [8.1787340787, 0.0000000000, 0.0000000000],
        [0.0000000000, 8.1787340787, 0.0000000000],
        [0.0000000000, 0.0000000000, 8.1787340787],
    ])  # bohr

    unit_cell = [
        vq.Atom(22, [  0.0000000000,   0.0000000000,   0.0000000000]),  # Z22 frac=(0.000,0.000,0.000)
        vq.Atom(22, [  4.0893670393,   4.0893670393,   0.0000000000]),  # Z22 frac=(0.500,0.500,0.000)
        vq.Atom(22, [  4.0893670393,   0.0000000000,   4.0893670393]),  # Z22 frac=(0.500,0.000,0.500)
        vq.Atom(22, [  0.0000000000,   4.0893670393,   4.0893670393]),  # Z22 frac=(0.000,0.500,0.500)
        vq.Atom( 6, [  4.0893670393,   4.0893670393,   4.0893670393]),  # C frac=(0.500,0.500,0.500)
        vq.Atom( 6, [  0.0000000000,   0.0000000000,   4.0893670393]),  # C frac=(0.000,0.000,0.500)
        vq.Atom( 6, [  0.0000000000,   4.0893670393,   0.0000000000]),  # C frac=(0.000,0.500,0.000)
        vq.Atom( 6, [  4.0893670393,   0.0000000000,   0.0000000000]),  # C frac=(0.500,0.000,0.000)
    ]
    ...
    print(f"  cell:       {lattice[0][0]:.4f} bohr (= 4.3280 Å)")
