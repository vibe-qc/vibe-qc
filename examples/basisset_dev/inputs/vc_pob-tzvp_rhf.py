...
Compound metadata:
    ...
    a, b, c (Å):    4.1630, 4.1630, 4.1630
    α, β, γ (deg):  90.00, 90.00, 90.00
    n_atoms in cell: 8
    multiplicity:   1
    structure src:  PT2013 Ref. 86
...
def main() -> None:
    lattice = np.array([
        [7.8669292905, 0.0000000000, 0.0000000000],
        [0.0000000000, 7.8669292905, 0.0000000000],
        [0.0000000000, 0.0000000000, 7.8669292905],
    ])  # bohr

    unit_cell = [
        vq.Atom(23, [  0.0000000000,   0.0000000000,   0.0000000000]),  # Z23 frac=(0.000,0.000,0.000)
        vq.Atom(23, [  3.9334646453,   3.9334646453,   0.0000000000]),  # Z23 frac=(0.500,0.500,0.000)
        vq.Atom(23, [  3.9334646453,   0.0000000000,   3.9334646453]),  # Z23 frac=(0.500,0.000,0.500)
        vq.Atom(23, [  0.0000000000,   3.9334646453,   3.9334646453]),  # Z23 frac=(0.000,0.500,0.500)
        vq.Atom( 6, [  3.9334646453,   3.9334646453,   3.9334646453]),  # C frac=(0.500,0.500,0.500)
        vq.Atom( 6, [  0.0000000000,   0.0000000000,   3.9334646453]),  # C frac=(0.000,0.000,0.500)
        vq.Atom( 6, [  0.0000000000,   3.9334646453,   0.0000000000]),  # C frac=(0.000,0.500,0.000)
        vq.Atom( 6, [  3.9334646453,   0.0000000000,   0.0000000000]),  # C frac=(0.500,0.000,0.000)
    ]
    ...
    print(f"  cell:       {lattice[0][0]:.4f} bohr (= 4.1630 Å)")
