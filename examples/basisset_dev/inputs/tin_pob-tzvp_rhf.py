...
Compound metadata:
    ...
    a, b, c (Å):    4.2350, 4.2350, 4.2350
    α, β, γ (deg):  90.00, 90.00, 90.00
    n_atoms in cell: 8
    multiplicity:   1
    structure src:  PT2013 Ref. 87
...
def main() -> None:
    lattice = np.array([
        [8.0029895617, 0.0000000000, 0.0000000000],
        [0.0000000000, 8.0029895617, 0.0000000000],
        [0.0000000000, 0.0000000000, 8.0029895617],
    ])  # bohr

    unit_cell = [
        vq.Atom(22, [  0.0000000000,   0.0000000000,   0.0000000000]),  # Z22 frac=(0.000,0.000,0.000)
        vq.Atom(22, [  4.0014947809,   4.0014947809,   0.0000000000]),  # Z22 frac=(0.500,0.500,0.000)
        vq.Atom(22, [  4.0014947809,   0.0000000000,   4.0014947809]),  # Z22 frac=(0.500,0.000,0.500)
        vq.Atom(22, [  0.0000000000,   4.0014947809,   4.0014947809]),  # Z22 frac=(0.000,0.500,0.500)
        vq.Atom( 7, [  4.0014947809,   4.0014947809,   4.0014947809]),  # N frac=(0.500,0.500,0.500)
        vq.Atom( 7, [  0.0000000000,   0.0000000000,   4.0014947809]),  # N frac=(0.000,0.000,0.500)
        vq.Atom( 7, [  0.0000000000,   4.0014947809,   0.0000000000]),  # N frac=(0.000,0.500,0.000)
        vq.Atom( 7, [  4.0014947809,   0.0000000000,   0.0000000000]),  # N frac=(0.500,0.000,0.000)
    ]
    ...
    print(f"  cell:       {lattice[0][0]:.4f} bohr (= 4.2350 Å)")
