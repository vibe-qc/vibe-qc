...
def main() -> None:
    lattice = np.array([
        [7.8140169629, 0.0000000000, 0.0000000000],
        [0.0000000000, 7.8140169629, 0.0000000000],
        [0.0000000000, 0.0000000000, 7.8140169629],
    ])  # bohr

    unit_cell = [
        vq.Atom(24, [  0.0000000000,   0.0000000000,   0.0000000000]),  # Z24 frac=(0.000,0.000,0.000)
        vq.Atom(24, [  3.9070084814,   3.9070084814,   0.0000000000]),  # Z24 frac=(0.500,0.500,0.000)
        vq.Atom(24, [  3.9070084814,   0.0000000000,   3.9070084814]),  # Z24 frac=(0.500,0.000,0.500)
        vq.Atom(24, [  0.0000000000,   3.9070084814,   3.9070084814]),  # Z24 frac=(0.000,0.500,0.500)
        vq.Atom( 7, [  3.9070084814,   3.9070084814,   3.9070084814]),  # N frac=(0.500,0.500,0.500)
        vq.Atom( 7, [  0.0000000000,   0.0000000000,   3.9070084814]),  # N frac=(0.000,0.000,0.500)
        vq.Atom( 7, [  0.0000000000,   3.9070084814,   0.0000000000]),  # N frac=(0.000,0.500,0.000)
        vq.Atom( 7, [  3.9070084814,   0.0000000000,   0.0000000000]),  # N frac=(0.500,0.000,0.000)
    ]
    ...
    print(f"  cell:       {lattice[0][0]:.4f} bohr (= 4.1350 Å)")
