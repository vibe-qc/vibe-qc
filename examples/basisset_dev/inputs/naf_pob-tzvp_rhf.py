...
Compound metadata:
    ...
    a, b, c (Å):    4.6320, 4.6320, 4.6320
    α, β, γ (deg):  90.00, 90.00, 90.00
    n_atoms in cell: 8
    multiplicity:   1
    structure src:  Rao, Sanyal, Phys. Rev. B 42, 1810 (1990) — Ref. 51 of PT2013
    appears in:     PT2013-T4, PT2013-T13, PT2013-T14, VO2019-T2

    Reference: PT2013 SI Table 2 lists this compound but the HF SCF did not converge in the paper (n-dash entry).
...
def main() -> None:
    lattice = np.array([
        [8.7532107792, 0.0000000000, 0.0000000000],
        [0.0000000000, 8.7532107792, 0.0000000000],
        [0.0000000000, 0.0000000000, 8.7532107792],
    ])  # bohr

    unit_cell = [
        vq.Atom(11, [  0.0000000000,   0.0000000000,   0.0000000000]),  # Na frac=(0.000,0.000,0.000)
        vq.Atom(11, [  4.3766053896,   4.3766053896,   0.0000000000]),  # Na frac=(0.500,0.500,0.000)
        vq.Atom(11, [  4.3766053896,   0.0000000000,   4.3766053896]),  # Na frac=(0.500,0.000,0.500)
        vq.Atom(11, [  0.0000000000,   4.3766053896,   4.3766053896]),  # Na frac=(0.000,0.500,0.500)
        vq.Atom( 9, [  4.3766053896,   4.3766053896,   4.3766053896]),  # F frac=(0.500,0.500,0.500)
        vq.Atom( 9, [  0.0000000000,   0.0000000000,   4.3766053896]),  # F frac=(0.000,0.000,0.500)
        vq.Atom( 9, [  0.0000000000,   4.3766053896,   0.0000000000]),  # F frac=(0.000,0.500,0.000)
        vq.Atom( 9, [  4.3766053896,   0.0000000000,   0.0000000000]),  # F frac=(0.500,0.000,0.000)
    ]
    ...
    print(f"  cell:       {lattice[0][0]:.4f} bohr (= 4.6320 Å)")
