...
Compound metadata:
    ...
    a, b, c (Å):    5.6530, 5.6530, 5.6530
    α, β, γ (deg):  90.00, 90.00, 90.00
    n_atoms in cell: 8
    multiplicity:   1
    structure src:  PT2013 Ref. 78
...
def main() -> None:
    lattice = np.array([
        [10.6826210136, 0.0000000000, 0.0000000000],
        [0.0000000000, 10.6826210136, 0.0000000000],
        [0.0000000000, 0.0000000000, 10.6826210136],
    ])  # bohr

    unit_cell = [
        vq.Atom(31, [  0.0000000000,   0.0000000000,   0.0000000000]),  # Z31 frac=(0.000,0.000,0.000)
        vq.Atom(31, [  5.3413105068,   5.3413105068,   0.0000000000]),  # Z31 frac=(0.500,0.500,0.000)
        vq.Atom(31, [  5.3413105068,   0.0000000000,   5.3413105068]),  # Z31 frac=(0.500,0.000,0.500)
        vq.Atom(31, [  0.0000000000,   5.3413105068,   5.3413105068]),  # Z31 frac=(0.000,0.500,0.500)
        vq.Atom(33, [  2.6706552534,   2.6706552534,   2.6706552534]),  # Z33 frac=(0.250,0.250,0.250)
        vq.Atom(33, [  8.0119657602,   8.0119657602,   2.6706552534]),  # Z33 frac=(0.750,0.750,0.250)
        vq.Atom(33, [  8.0119657602,   2.6706552534,   8.0119657602]),  # Z33 frac=(0.750,0.250,0.750)
        vq.Atom(33, [  2.6706552534,   8.0119657602,   8.0119657602]),  # Z33 frac=(0.250,0.750,0.750)
    ]
    ...
    print(f"  cell:       {lattice[0][0]:.4f} bohr (= 5.6530 Å)")
