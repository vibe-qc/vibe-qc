...
def main() -> None:
    lattice = np.array([
        [7.8177964148, 0.0000000000, 0.0000000000],
        [0.0000000000, 7.8177964148, 0.0000000000],
        [0.0000000000, 0.0000000000, 7.8177964148],
    ])  # bohr

    unit_cell = [
        vq.Atom(23, [  0.0000000000,   0.0000000000,   0.0000000000]),  # Z23 frac=(0.000,0.000,0.000)
        vq.Atom(23, [  3.9088982074,   3.9088982074,   0.0000000000]),  # Z23 frac=(0.500,0.500,0.000)
        vq.Atom(23, [  3.9088982074,   0.0000000000,   3.9088982074]),  # Z23 frac=(0.500,0.000,0.500)
        vq.Atom(23, [  0.0000000000,   3.9088982074,   3.9088982074]),  # Z23 frac=(0.000,0.500,0.500)
        vq.Atom( 7, [  3.9088982074,   3.9088982074,   3.9088982074]),  # N frac=(0.500,0.500,0.500)
        vq.Atom( 7, [  0.0000000000,   0.0000000000,   3.9088982074]),  # N frac=(0.000,0.000,0.500)
        vq.Atom( 7, [  0.0000000000,   3.9088982074,   0.0000000000]),  # N frac=(0.000,0.500,0.000)
        vq.Atom( 7, [  3.9088982074,   0.0000000000,   0.0000000000]),  # N frac=(0.500,0.000,0.000)
    ]
    ...
    print(f"  cell:       {lattice[0][0]:.4f} bohr (= 4.1370 Å)")
