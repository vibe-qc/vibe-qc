...
Compound metadata:
    ...
    a, b, c (Å):    3.8170, 3.8170, 3.8170
    α, β, γ (deg):  90.00, 90.00, 90.00
    n_atoms in cell: 4
    multiplicity:   1
    structure src:  PT2013 Ref. 84
...
def main() -> None:
    lattice = np.array([
        [7.2130840985, 0.0000000000, 0.0000000000],
        [0.0000000000, 7.2130840985, 0.0000000000],
        [0.0000000000, 0.0000000000, 7.2130840985],
    ])  # bohr

    unit_cell = [
        vq.Atom(29, [  3.6065420492,   3.6065420492,   0.0000000000]),  # Z29 frac=(0.500,0.500,0.000)
        vq.Atom(29, [  3.6065420492,   0.0000000000,   3.6065420492]),  # Z29 frac=(0.500,0.000,0.500)
        vq.Atom(29, [  0.0000000000,   3.6065420492,   3.6065420492]),  # Z29 frac=(0.000,0.500,0.500)
        vq.Atom( 7, [  0.0000000000,   0.0000000000,   0.0000000000]),  # N frac=(0.000,0.000,0.000)
    ]
    ...
    print(f"  cell:       {lattice[0][0]:.4f} bohr (= 3.8170 Å)")
