...
Compound metadata:
    ...
    a, b, c (Å):    4.3650, 4.3650, 4.3650
    α, β, γ (deg):  90.00, 90.00, 90.00
    n_atoms in cell: 8
    multiplicity:   1
    structure src:  PT2013 Ref. 45
...
def main() -> None:
    lattice = np.array([
        [8.2486539402, 0.0000000000, 0.0000000000],
        [0.0000000000, 8.2486539402, 0.0000000000],
        [0.0000000000, 0.0000000000, 8.2486539402],
    ])  # bohr

    unit_cell = [
        vq.Atom(13, [  0.0000000000,   0.0000000000,   0.0000000000]),  # Al frac=(0.000,0.000,0.000)
        vq.Atom(13, [  4.1243269701,   4.1243269701,   0.0000000000]),  # Al frac=(0.500,0.500,0.000)
        vq.Atom(13, [  4.1243269701,   0.0000000000,   4.1243269701]),  # Al frac=(0.500,0.000,0.500)
        vq.Atom(13, [  0.0000000000,   4.1243269701,   4.1243269701]),  # Al frac=(0.000,0.500,0.500)
        vq.Atom( 7, [  2.0621634851,   2.0621634851,   2.0621634851]),  # N frac=(0.250,0.250,0.250)
        vq.Atom( 7, [  6.1864904552,   6.1864904552,   2.0621634851]),  # N frac=(0.750,0.750,0.250)
        vq.Atom( 7, [  6.1864904552,   2.0621634851,   6.1864904552]),  # N frac=(0.750,0.250,0.750)
        vq.Atom( 7, [  2.0621634851,   6.1864904552,   6.1864904552]),  # N frac=(0.250,0.750,0.750)
    ]
    ...
    print(f"  cell:       {lattice[0][0]:.4f} bohr (= 4.3650 Å)")
