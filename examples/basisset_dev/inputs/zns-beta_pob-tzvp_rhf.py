"""β-ZnS (zincblende) — RHF on pob-tzvp (Γ-only).
...
Compound metadata:
    formula:        β-ZnS (zincblende)
    space group:    F-43m
    crystal system: cubic
    a, b, c (Å):    5.4000, 5.4000, 5.4000
    α, β, γ (deg):  90.00, 90.00, 90.00
    n_atoms in cell: 8
    multiplicity:   1
    structure src:  PT2013 Ref. 30
...
def main() -> None:
    lattice = np.array([
        [10.2045203384, 0.0000000000, 0.0000000000],
        [0.0000000000, 10.2045203384, 0.0000000000],
        [0.0000000000, 0.0000000000, 10.2045203384],
    ])  # bohr

    unit_cell = [
        vq.Atom(30, [  0.0000000000,   0.0000000000,   0.0000000000]),  # Z30 frac=(0.000,0.000,0.000)
        vq.Atom(30, [  5.1022601692,   5.1022601692,   0.0000000000]),  # Z30 frac=(0.500,0.500,0.000)
        vq.Atom(30, [  5.1022601692,   0.0000000000,   5.1022601692]),  # Z30 frac=(0.500,0.000,0.500)
        vq.Atom(30, [  0.0000000000,   5.1022601692,   5.1022601692]),  # Z30 frac=(0.000,0.500,0.500)
        vq.Atom(16, [  2.5511300846,   2.5511300846,   2.5511300846]),  # S frac=(0.250,0.250,0.250)
        vq.Atom(16, [  7.6533902538,   7.6533902538,   2.5511300846]),  # S frac=(0.750,0.750,0.250)
        vq.Atom(16, [  7.6533902538,   2.5511300846,   7.6533902538]),  # S frac=(0.750,0.250,0.750)
        vq.Atom(16, [  2.5511300846,   7.6533902538,   7.6533902538]),  # S frac=(0.250,0.750,0.750)
    ]
    ...
    print(f"  cell:       {lattice[0][0]:.4f} bohr (= 5.4000 Å)")
