...
Compound metadata:
    ...
    a, b, c (Å):    5.4310, 5.4310, 5.4310
    α, β, γ (deg):  90.00, 90.00, 90.00
    n_atoms in cell: 8
    multiplicity:   1
    structure src:  PT2013 Ref. 25
...
def main() -> None:
    lattice = np.array([
        [10.2631018441, 0.0000000000, 0.0000000000],
        [0.0000000000, 10.2631018441, 0.0000000000],
        [0.0000000000, 0.0000000000, 10.2631018441],
    ])  # bohr

    unit_cell = [
        vq.Atom(14, [  0.0000000000,   0.0000000000,   0.0000000000]),  # Si frac=(0.000,0.000,0.000)
        vq.Atom(14, [  5.1315509220,   5.1315509220,   0.0000000000]),  # Si frac=(0.500,0.500,0.000)
        vq.Atom(14, [  5.1315509220,   0.0000000000,   5.1315509220]),  # Si frac=(0.500,0.000,0.500)
        vq.Atom(14, [  0.0000000000,   5.1315509220,   5.1315509220]),  # Si frac=(0.000,0.500,0.500)
        vq.Atom(14, [  2.5657754610,   2.5657754610,   2.5657754610]),  # Si frac=(0.250,0.250,0.250)
        vq.Atom(14, [  7.6973263831,   7.6973263831,   2.5657754610]),  # Si frac=(0.750,0.750,0.250)
        vq.Atom(14, [  7.6973263831,   2.5657754610,   7.6973263831]),  # Si frac=(0.750,0.250,0.750)
        vq.Atom(14, [  2.5657754610,   7.6973263831,   7.6973263831]),  # Si frac=(0.250,0.750,0.750)
    ]
    ...
    print(f"  cell:       {lattice[0][0]:.4f} bohr (= 5.4310 Å)")
