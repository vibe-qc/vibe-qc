...
Compound metadata:
    ...
    a, b, c (Å):    5.4210, 5.4210, 5.4210
    α, β, γ (deg):  90.00, 90.00, 90.00
    n_atoms in cell: 8
    multiplicity:   1
    structure src:  PT2013 Ref. 76
...
def main() -> None:
    lattice = np.array([
        [10.2442045842, 0.0000000000, 0.0000000000],
        [0.0000000000, 10.2442045842, 0.0000000000],
        [0.0000000000, 0.0000000000, 10.2442045842],
    ])  # bohr

    unit_cell = [
        vq.Atom(13, [  0.0000000000,   0.0000000000,   0.0000000000]),  # Al frac=(0.000,0.000,0.000)
        vq.Atom(13, [  5.1221022921,   5.1221022921,   0.0000000000]),  # Al frac=(0.500,0.500,0.000)
        vq.Atom(13, [  5.1221022921,   0.0000000000,   5.1221022921]),  # Al frac=(0.500,0.000,0.500)
        vq.Atom(13, [  0.0000000000,   5.1221022921,   5.1221022921]),  # Al frac=(0.000,0.500,0.500)
        vq.Atom(15, [  2.5610511461,   2.5610511461,   2.5610511461]),  # P frac=(0.250,0.250,0.250)
        vq.Atom(15, [  7.6831534382,   7.6831534382,   2.5610511461]),  # P frac=(0.750,0.750,0.250)
        vq.Atom(15, [  7.6831534382,   2.5610511461,   7.6831534382]),  # P frac=(0.750,0.250,0.750)
        vq.Atom(15, [  2.5610511461,   7.6831534382,   7.6831534382]),  # P frac=(0.250,0.750,0.750)
    ]
    ...
    print(f"  cell:       {lattice[0][0]:.4f} bohr (= 5.4210 Å)")
