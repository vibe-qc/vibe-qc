...
Compound metadata:
    ...
    a, b, c (Å):    5.6210, 5.6210, 5.6210
    α, β, γ (deg):  90.00, 90.00, 90.00
    n_atoms in cell: 8
    multiplicity:   1
    structure src:  PT2013 Ref. 26
...
def main() -> None:
    lattice = np.array([
        [10.6221497819, 0.0000000000, 0.0000000000],
        [0.0000000000, 10.6221497819, 0.0000000000],
        [0.0000000000, 0.0000000000, 10.6221497819],
    ])  # bohr

    unit_cell = [
        vq.Atom(32, [  0.0000000000,   0.0000000000,   0.0000000000]),  # Z32 frac=(0.000,0.000,0.000)
        vq.Atom(32, [  5.3110748910,   5.3110748910,   0.0000000000]),  # Z32 frac=(0.500,0.500,0.000)
        vq.Atom(32, [  5.3110748910,   0.0000000000,   5.3110748910]),  # Z32 frac=(0.500,0.000,0.500)
        vq.Atom(32, [  0.0000000000,   5.3110748910,   5.3110748910]),  # Z32 frac=(0.000,0.500,0.500)
        vq.Atom(32, [  2.6555374455,   2.6555374455,   2.6555374455]),  # Z32 frac=(0.250,0.250,0.250)
        vq.Atom(32, [  7.9666123364,   7.9666123364,   2.6555374455]),  # Z32 frac=(0.750,0.750,0.250)
        vq.Atom(32, [  7.9666123364,   2.6555374455,   7.9666123364]),  # Z32 frac=(0.750,0.250,0.750)
        vq.Atom(32, [  2.6555374455,   7.9666123364,   7.9666123364]),  # Z32 frac=(0.250,0.750,0.750)
    ]
    ...
    print(f"  cell:       {lattice[0][0]:.4f} bohr (= 5.6210 Å)")
