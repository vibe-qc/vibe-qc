"""SiO2-alpha-quartz — RKS-B3LYP / pob-tzvp / Γ via the native GDF driver.
...
Run::
    .venv/bin/python examples/periodic/SiO2-alpha-quartz/SiO2-alpha-quartz-RKS-B3LYP-pobtzvp.py
