"""MgO rocksalt primitive cell -- RKS-PBE / pob-TZVP / 8x8x8 native GDF target.

Standalone vibe-qc input for side-by-side CRYSTAL14 parity.

CRYSTAL14 partner:
    MgO-rocksalt-RKS-PBE-pobtzvp-mp8-crystal14.d12
...
if __name__ == "__main__":
    ...
    with vq.perf_log(OUT_STEM.with_suffix(".perf")):
        plog.banner("MgO rocksalt / primitive / RKS-PBE / pob-TZVP / native GDF target")
