"""PySCF mirror — Ne-fcc RKS-B3LYP / pob-tzvp / Γ via GDF
(exxdiv=ewald). Same geometry / basis as
``../../periodic/Ne-fcc/Ne-fcc-RKS-B3LYP-pobtzvp.py``.

Run::
    .venv/bin/python examples/periodic_pyscf/Ne-fcc/Ne-fcc-RKS-B3LYP-pobtzvp.py
Produces:
    {stem}.out
"""
