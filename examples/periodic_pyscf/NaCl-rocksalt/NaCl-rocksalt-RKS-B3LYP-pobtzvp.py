"""PySCF mirror — NaCl-rocksalt RKS-B3LYP / pob-tzvp / Γ via GDF
(exxdiv=ewald). Same geometry / basis as
``../../periodic/NaCl-rocksalt/NaCl-rocksalt-RKS-B3LYP-pobtzvp.py``.

Run::
    .venv/bin/python examples/periodic_pyscf/NaCl-rocksalt/NaCl-rocksalt-RKS-B3LYP-pobtzvp.py
Produces:
    {stem}.out
"""
...
CELL_ANG = [[5.64, 0.0, 0.0], [0.0, 5.64, 0.0], [0.0, 0.0, 5.64]]
ATOM_DATA = [('Na', [0.0, 0.0, 0.0]),
 ('Na', [0.0, 2.82, 2.82]),
 ('Na', [2.82, 0.0, 2.82]),
 ('Na', [2.82, 2.82, 0.0]),
 ('Cl', [2.82, 2.82, 2.82]),
