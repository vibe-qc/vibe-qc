"""PySCF mirror — NaCl-rocksalt RHF / pob-tzvp / Γ via GDF
(exxdiv=ewald). Same geometry / basis as
``../../periodic/NaCl-rocksalt/NaCl-rocksalt-RHF-pobtzvp.py``.

Run::
    .venv/bin/python examples/periodic_pyscf/NaCl-rocksalt/NaCl-rocksalt-RHF-pobtzvp.py
Produces:
    {stem}.out
"""
