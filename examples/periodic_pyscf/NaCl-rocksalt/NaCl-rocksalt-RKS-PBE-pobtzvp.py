"""PySCF mirror — NaCl-rocksalt RKS-PBE / pob-tzvp / Γ via GDF
(exxdiv=ewald). Same geometry / basis as
``../../periodic/NaCl-rocksalt/NaCl-rocksalt-RKS-PBE-pobtzvp.py``.

Run::
    .venv/bin/python examples/periodic_pyscf/NaCl-rocksalt/NaCl-rocksalt-RKS-PBE-pobtzvp.py
Produces:
    {stem}.out
"""
