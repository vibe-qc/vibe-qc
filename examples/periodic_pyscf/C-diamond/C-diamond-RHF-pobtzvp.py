"""PySCF mirror — C-diamond RHF / pob-tzvp / Γ via GDF
(exxdiv=ewald). Same geometry / basis as
``../../periodic/C-diamond/C-diamond-RHF-pobtzvp.py``.

Run::
    .venv/bin/python examples/periodic_pyscf/C-diamond/C-diamond-RHF-pobtzvp.py
Produces:
    {stem}.out
"""
