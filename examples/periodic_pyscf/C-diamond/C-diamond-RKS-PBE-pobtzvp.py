"""PySCF mirror — C-diamond RKS-PBE / pob-tzvp / Γ via GDF
(exxdiv=ewald). Same geometry / basis as
``../../periodic/C-diamond/C-diamond-RKS-PBE-pobtzvp.py``.

Run::
    .venv/bin/python examples/periodic_pyscf/C-diamond/C-diamond-RKS-PBE-pobtzvp.py
Produces:
    {stem}.out
"""
