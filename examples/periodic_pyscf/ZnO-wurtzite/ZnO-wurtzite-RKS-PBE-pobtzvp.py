"""PySCF mirror — ZnO-wurtzite RKS-PBE / pob-tzvp / Γ via GDF
(exxdiv=ewald). Same geometry / basis as
``../../periodic/ZnO-wurtzite/ZnO-wurtzite-RKS-PBE-pobtzvp.py``.

Run::
    .venv/bin/python examples/periodic_pyscf/ZnO-wurtzite/ZnO-wurtzite-RKS-PBE-pobtzvp.py
Produces:
    {stem}.out
"""
