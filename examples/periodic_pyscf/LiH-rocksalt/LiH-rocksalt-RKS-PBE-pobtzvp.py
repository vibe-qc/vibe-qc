"""PySCF mirror — LiH-rocksalt RKS-PBE / pob-tzvp / Γ via GDF
(exxdiv=ewald). Same geometry / basis as
``../../periodic/LiH-rocksalt/LiH-rocksalt-RKS-PBE-pobtzvp.py``.

Run::
    .venv/bin/python examples/periodic_pyscf/LiH-rocksalt/LiH-rocksalt-RKS-PBE-pobtzvp.py
Produces:
    {stem}.out
"""
