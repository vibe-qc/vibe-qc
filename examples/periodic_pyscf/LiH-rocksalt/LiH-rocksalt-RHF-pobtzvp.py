"""PySCF mirror — LiH-rocksalt RHF / pob-tzvp / Γ via GDF
(exxdiv=ewald). Same geometry / basis as
``../../periodic/LiH-rocksalt/LiH-rocksalt-RHF-pobtzvp.py``.

Run::
    .venv/bin/python examples/periodic_pyscf/LiH-rocksalt/LiH-rocksalt-RHF-pobtzvp.py
Produces:
    {stem}.out
"""
