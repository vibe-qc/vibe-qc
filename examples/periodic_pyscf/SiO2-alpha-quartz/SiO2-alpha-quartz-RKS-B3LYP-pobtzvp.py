"""PySCF mirror — SiO2-alpha-quartz RKS-B3LYP / pob-tzvp / Γ via GDF
(exxdiv=ewald). Same geometry / basis as
``../../periodic/SiO2-alpha-quartz/SiO2-alpha-quartz-RKS-B3LYP-pobtzvp.py``.

Run::
    .venv/bin/python examples/periodic_pyscf/SiO2-alpha-quartz/SiO2-alpha-quartz-RKS-B3LYP-pobtzvp.py
Produces:
    {stem}.out
"""
