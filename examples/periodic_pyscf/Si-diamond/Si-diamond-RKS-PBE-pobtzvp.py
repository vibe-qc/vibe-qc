"""PySCF mirror — Si-diamond RKS-PBE / pob-tzvp / Γ via GDF
(exxdiv=ewald). Same geometry / basis as
``../../periodic/Si-diamond/Si-diamond-RKS-PBE-pobtzvp.py``.

Run::
    .venv/bin/python examples/periodic_pyscf/Si-diamond/Si-diamond-RKS-PBE-pobtzvp.py
Produces:
    {stem}.out
"""
