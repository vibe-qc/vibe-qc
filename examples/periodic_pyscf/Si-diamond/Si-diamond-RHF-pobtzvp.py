"""PySCF mirror — Si-diamond RHF / pob-tzvp / Γ via GDF
(exxdiv=ewald). Same geometry / basis as
``../../periodic/Si-diamond/Si-diamond-RHF-pobtzvp.py``.

Run::
    .venv/bin/python examples/periodic_pyscf/Si-diamond/Si-diamond-RHF-pobtzvp.py
Produces:
    {stem}.out
"""
