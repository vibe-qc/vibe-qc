"""PySCF mirror — TiO2-rutile RHF / pob-tzvp / Γ via GDF
(exxdiv=ewald). Same geometry / basis as
``../../periodic/TiO2-rutile/TiO2-rutile-RHF-pobtzvp.py``.

Run::
    .venv/bin/python examples/periodic_pyscf/TiO2-rutile/TiO2-rutile-RHF-pobtzvp.py
Produces:
    {stem}.out
"""
