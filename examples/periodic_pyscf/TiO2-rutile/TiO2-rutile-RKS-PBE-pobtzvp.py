"""PySCF mirror — TiO2-rutile RKS-PBE / pob-tzvp / Γ via GDF
(exxdiv=ewald). Same geometry / basis as
``../../periodic/TiO2-rutile/TiO2-rutile-RKS-PBE-pobtzvp.py``.

Run::
    .venv/bin/python examples/periodic_pyscf/TiO2-rutile/TiO2-rutile-RKS-PBE-pobtzvp.py
Produces:
    {stem}.out
"""
