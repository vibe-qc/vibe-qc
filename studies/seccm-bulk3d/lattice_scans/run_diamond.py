"""compute-cluster lattice scan: C diamond 2x2x2.

Usage: run_diamond.py a1 a2 a3 ...  (lattice constants in Angstrom)
...
def run_point(a_angstrom: float):
    ...
    basis = [np.zeros(3), np.array([0.25, 0.25, 0.25]) * a_angstrom]
    ...
    res = run_gfn2_seccm(mol, topo, max_iter=3000)
